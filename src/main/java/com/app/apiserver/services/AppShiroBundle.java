 ...
 */
public abstract class AppShiroBundle<T> implements ConfiguredBundle<T> {
    ...
    public void run(T configuration, Environment environment) {
        AppShiroConfiguration shiroConfig = narrow(configuration);
     ...
     */
    protected abstract AppShiroConfiguration narrow(T configuration);
